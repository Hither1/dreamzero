            ...
            for elem in features:
                ...
                try:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        if num_views > 1:
                            processed_item = "A multi-view video shows that a robot " + processed_item.lower() + " The video is split into two views: The top-left view shows the camera view from the robot's front camera, and the bottom-left view shows the camera view from the robot's wrist camera. The robot " + processed_item.lower()
                        else:
                            processed_item = "A video shows that a robot " + processed_item.lower()
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        if num_views > 1:
                            item = "A multi-view video shows that a robot " + str(item).lower() + " The video is split into two views: The top-left view shows the camera view from the robot's front camera, and the bottom-left view shows the camera view from the robot's wrist camera. The robot " + str(item).lower()
                        else:
                            item = "A video shows that a robot " + str(item).lower()
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")
